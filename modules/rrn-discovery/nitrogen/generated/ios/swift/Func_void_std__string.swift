...
/**
 * Wraps a Swift `(_ name: String) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_std__string {
  public typealias bridge = margelo.nitro.rrndiscovery.bridge.swift

  private let closure: (_ name: String) -> Void

  public init(_ closure: @escaping (_ name: String) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(name: std.string) -> Void {
    self.closure(String(name))
  }
